...
to influence task placement, priorities or arbitrary other properties.
...
have been developed cooperatily and therefore the executor is aware of 
the scheduler capabilities beforehand). 
This approach is well suited to the concept of a model of executors that are 
lightweight, copyable and does not introduce the possibility of races or exceptions

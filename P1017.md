...
Therefore, the definition of interfaces pertaining to similar tasks should be 
...
the interfaces variadic. We have implemented a All of the APIs exposed by HPX that require scheduling 
new tasks are implemented on top of our executor implementation.
